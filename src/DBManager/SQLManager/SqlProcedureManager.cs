...
namespace DBManager.SQLManager
{
    public class SqlProcedureManager
    {
        ...
        public SqlProcedureManager(string ConnStr)
        {
            ...
            SqlProcedureManager.ConStr = ConnStr.ToString();
        ...
        private DataSet ExecuteDataset(ref string dbResp, string connectionstring, CommandType commandType, string commandText)
        {
            return ExecuteDataset(ref dbResp, connectionstring, commandType, commandText, null);
        }
        private DataSet ExecuteDataset(ref string dbResp, SqlConnection connection, CommandType commandType, string commandText, params System.Data.SqlClient.SqlParameter[] commandParameters)
        {
            if (connection == null)
            {
                throw new ArgumentNullException("connection");
            ...
            {
                dbResp = dbResp+ " DB Error:" + errorExcep.Message;
        ...
        private DataSet ExecuteDataset(ref string dbResp, string connectionstring, CommandType commandType, string commandText, params System.Data.SqlClient.SqlParameter[] commandParameters)
        {
            DataSet dataSet;
            if ((connectionstring == null) || (connectionstring.Length == 0))
            {
            ...
            try
            {
                this.SqlCon = new SqlConnection(connectionstring);
                this.SqlCon.Open();
                dataSet = this.ExecuteDataset(ref dbResp, this.SqlCon, commandType, commandText, commandParameters);
            }
            finally
            {
                if (this.SqlCon != null)
        ...
        public DataSet ExecuteDataset(string spName, ref string errMsg, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                SqlParameter[] parameterArray1 = this.GetSpParameterSet(SqlProcedureManager.ConStr, spName, ref errMsg);
                this.AssignParameterValues(parameterArray1, parameterValues, ref errMsg);
                return this.ExecuteDataset(ref errMsg, SqlProcedureManager.ConStr, CommandType.StoredProcedure, spName, parameterArray1);
            }
            return this.ExecuteDataset(ref errMsg, SqlProcedureManager.ConStr, CommandType.StoredProcedure, spName);
        ...
        public DataTable ExecuteDataTable(string spName, ref string errMsg, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                SqlParameter[] parameterArray1 = this.GetSpParameterSet(SqlProcedureManager.ConStr, spName, ref errMsg);
                this.AssignParameterValues(parameterArray1, parameterValues, ref errMsg);
                return this.ExecuteDataset(ref errMsg, SqlProcedureManager.ConStr, CommandType.StoredProcedure, spName, parameterArray1).Tables[0];
            }
            return this.ExecuteDataset(ref errMsg, SqlProcedureManager.ConStr, CommandType.StoredProcedure, spName).Tables[0];
        ...
        public string ExecuteInsertRequest(string AppId, string DeviceIP, string MTI, string MText, string RefNo, ref string errMsg)
        {
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("SP_InUp_SMS_TP_Message", conn))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@MText", MText);

                        cmd.Parameters.AddWithValue("@RefNo", RefNo);
                        SqlParameter paramRespNo = new SqlParameter("@RespNo", SqlDbType.VarChar, 50);
                        paramRespNo.Direction = ParameterDirection.Output;
                        cmd.Parameters.Add(paramRespNo);
                        SqlParameter paramRespCode = new SqlParameter("@RespCode", SqlDbType.VarChar, 10);
                        paramRespCode.Direction = ParameterDirection.Output;
                        cmd.Parameters.Add(paramRespCode);
                        cmd.Parameters.AddWithValue("@ExecuteType", "1");
                        if (cmd.ExecuteNonQuery() > 0)
                        {
                            string response = paramRespNo.Value.ToString();
                            errMsg = "Success";
                            //return lastId;
                            return response;
                        }
